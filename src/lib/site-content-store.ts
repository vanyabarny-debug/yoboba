...
сервис подарков доступен при заказе через yomoyo. подарок нельзя обменять на деньги. если одаряемый не забрал напиток в срок, заказ может быть аннулирован.`,
  },
  {
    ...
    body: `снял короткое видео с yomoyo — набрало больше 25 000 просмотров — получи бесплатный бабл ти.

подойдут клипы вк и другие короткие ролики. главное: yomoyo видно или слышно, а просмотров больше 25к.

## как получить

сними ролик и упомяни yomoyo.
набери больше 25 000 просмотров.
напиши в vk или покажи видео в точке.
забери напиток.

## условия

один ролик — один напиток.
ролик должен быть открыт.
напиток только в точке, без обмена на деньги.`,
  },
  {
