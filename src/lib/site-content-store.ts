...
слово пришло из тайваньского bubble tea и закрепилось в английском как boba / boba tea. по сути это привычное имя тех же шариков из крахмала маниоки, которые в русском чаще зовут просто «тапиока» или «шарики». у нас еда — **боба**, а баллы лояльности — отдельно: **бобабаллы** (коротко **бб**).
...
за каждый оплаченный напиток начисляем **50 бобабаллов** — столько же, сколько шариков в порции. накопи **250 бб** (пять напитков) — забери напиток бесплатно в корзине или на кассе. закуски не копятся, за подарок бобабаллы не капают.`,
  },
  {
