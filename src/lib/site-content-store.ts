...
export const site_content_version = 21;
...
export const default_top_bar_links: top_bar_link[] = [
  ...
  { id: 'tapioca', label: 'боба', href: '/boby', is_active: true },
];
...
боба (boba) — так называют жевательные шарики тапиоки. это не отдельный ингредиент «сверху», а те самые крупные шарики на дне стакана бабл ти.

## откуда слово

слово пришло из тайваньского bubble tea и закрепилось в английском как boba / boba tea. по сути это привычное имя тех же шариков из крахмала маниоки, которые в русском чаще зовут просто «тапиока» или «шарики». у нас еда — **боба**, а баллы лояльности — отдельно: **бобаллы** (коротко **бб**).

## как варят правильно

сухие шарики варят в кипятке до упругой текстуры («кью-кью»), затем томят под крышкой и держат в сиропе, чтобы не засохли и не раскисли. без тайминга шарики получаются либо твёрдыми, либо кашей.

## как варим мы

каждый день с нуля: чёткий тайминг варки, томление и купание в карамельном сиропе. без «вчерашних» шариков.

## порция в напитке

в средний стакан кладём около **50 г** варёной бобы — это примерно **50 шариков**.

## копи бобаллы

за каждый оплаченный напиток начисляем **50 бобаллов** — столько же, сколько шариков в порции. накопи **250 бб** (пять напитков) — забери напиток бесплатно в корзине или на кассе. закуски не копятся, за подарок бобаллы не капают.`,
  },
  {
