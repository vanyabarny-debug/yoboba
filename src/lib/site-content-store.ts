...
скидка действует постоянно в точках yomoyo. документ должен принадлежать гостю, который оформляет заказ. акция не суммируется с другими скидками и комбо, если не сказано иное. по вопросам — hello@yomoyo.ru или у бариста.`,
  },
  {
    ...
    body: `хочешь сделать приятное — подари напиток yomoyo. укажи номер телефона одаряемой при заказе: ей придёт уведомление, что от тебя подарок, и она сможет забрать его в точке.

тепло без лишних слов: ты выбираешь напиток, она получает сюрприз.

## как это работает

1. выбери напиток
собери заказ как обычно — тот самый вкус, который хочешь подарить.

2. укажи номер одаряемой
в оформлении заказа введи телефон человека, которому даришь. это и есть одаряемая.

3. ей придёт уведомление
на указанный номер уйдёт сообщение, что от тебя есть подарок в yomoyo — с деталями, как забрать.
...
2. срок и точка
забрать подарок нужно в срок и в точке, указанных в уведомлении. уточняй детали в сообщении.

3. если номер ошибочный
проверь номер перед отправкой: уведомление уйдёт туда, куда ты указал.

## правила

сервис подарков доступен при заказе через yomoyo. организатор — yomoyo. подарок нельзя обменять на деньги. если одаряемая не забрала напиток в срок, заказ может быть аннулирован по правилам точки. вопросы: hello@yomoyo.ru.`,
  },
  {
