...
export const site_content_version = 23;
...
export const default_top_bar_links: top_bar_link[] = [
  ...
  { id: 'tapioca', label: 'копи бобы', href: '/boby', is_active: true },
];
...
слово пришло из тайваньского bubble tea и закрепилось в английском как boba / boba tea. по сути это привычное имя тех же шариков из крахмала маниоки, которые в русском чаще зовут просто «тапиока» или «шарики».
...
в средний стакан кладём около **50 г** варёной бобы — это примерно **50 шариков**. столько же бобаллов (бб) капает за один оплаченный напиток. накопи **250 бб** — пять порций — и забери напиток бесплатно.`,
  },
  {
