...
export const site_content_version = 29;
...
const default_category_nutrition: Record<string, category_nutrition> = {
  ...
  лимонады: { kcal: 44, protein: 0.2, fat: 0.1, carb: 10.8 },
  'на фруктовом пюре': { kcal: 58, protein: 0.6, fat: 0.4, carb: 13.5 },
  'напиток месяца': { kcal: 42, protein: 0.2, fat: 0.1, carb: 10.2 },
...
const default_compositions: Record<string, string> = {
  ...
  лимонады: 'газированная вода, джус-боллы, сироп или концентрат, лёд',
  'на фруктовом пюре': 'фруктовое пюре, молоко, джус-боллы, лёд',
  'напиток месяца': 'газированная вода, джус-боллы, сироп, лёд',
  комбо: 'напитки 500 мл на выбор',
};
...
const default_descriptions: Record<string, string> = {
  ...
  лимонады: 'газированные лимонады с джус-боллами.',
  'на фруктовом пюре': 'напитки на фруктовом пюре с джус-боллами.',
  'напиток месяца': 'лимитированный вкус месяца.',
  комбо: 'наборы напитков 500 мл на выбор.',
};
...
export const default_top_bar_links: top_bar_link[] = [
  ...
  { id: 'tapioca', label: 'копи баллы', href: '/boby', is_active: true },
];
...
если любишь bubble tea, умеешь работать в ритме и хочешь расти вместе с брендом — звони:

8 996 270-96-00

расскажем про смены, оплату и ближайшую точку.`,
  },
  {
    slug: 'kontakty',
    title: 'контакты',
    body: '8 (980) 637-94-98',
  },
  {
    slug: 'akcii',
    title: 'акции',
...
скидка действует постоянно в точках yomoyo. документ должен принадлежать гостю, который оформляет заказ. акция не суммируется с другими скидками и комбо, если не сказано иное.`,
  },
  {
...
сервис подарков доступен при заказе через yomoyo. подарок нельзя обменять на деньги. если одаряемый не забрал напиток в срок, заказ может быть аннулирован.`,
  },
  {
    slug: 'akciya-25k-prosmotrov',
    title: '25 000 просмотров = бесплатный бабл ти',
    body: `снимаешь короткое видео, упоминаешь yomoyo — и если ролик набирает больше 25 000 просмотров, мы нальём тебе бесплатный бабл ти.

платформа любая: reels, shorts, tiktok, клипы вк и другие короткие видео в интернете. главное — чтобы yomoyo было видно или слышно в ролике, а счётчик просмотров перевалил за 25 тысяч.

## как это работает

1. сними короткое видео
покажи напиток, точку, атмосферу — как удобно. упомяни yomoyo: в кадре, в тексте, в голосе или в описании.

2. набери больше 25 000 просмотров
считаются просмотры именно этого ролика. одно видео — один бесплатный напиток. снял ещё одно и снова больше 25к — можно снова.

3. покажи нам ролик
напиши в сообщество вк yomoyo или подойди в точку с открытым видео: бариста / команда проверит упоминание и счётчик.

4. забери бабл ти
после подтверждения выберем напиток из меню и нальём бесплатно в точке.

## что важно знать

1. просмотры
нужно больше 25 000 на одном коротком видео. лайки и подписчики не заменяют просмотры.

2. упоминание yomoyo
бренд должен быть понятен зрителю: название в кадре, в речи, на стакане или в подписи к ролику.

3. публичность
ролик должен быть открыт для просмотра — закрытые аккаунты и удалённые видео не проходят.

4. один ролик — один напиток
за каждое отдельное видео с порогом 25к можно получить один бесплатный бабл ти.

## правила

акция действует в точках yomoyo. напиток нельзя обменять на деньги или передать без согласования. мы можем отказать, если нет явного упоминания бренда, счётчик ниже порога или ролик недоступен. условия могут уточняться — актуальная версия всегда на этой странице.`,
  },
  {
...
1. найди в меню
открой категорию «напиток месяца» — там сабзиро с плашкой «месяца».
...
боба (boba) — жевательные шарики тапиоки на дне стакана бабл ти. это не «добавка сверху», а те самые крупные шарики из крахмала маниоки.

## откуда слово

слово пришло из тайваньского bubble tea и закрепилось как boba / boba tea. в русском чаще говорят «тапиока» или просто «шарики».

## как варят правильно

сухие шарики варят в кипятке до упругой текстуры («кью-кью»), затем томят под крышкой и держат в сиропе. без тайминга они получаются либо твёрдыми, либо кашей.

## как варим мы

каждый день с нуля: чёткий тайминг, томление и карамельный сироп. без «вчерашних» шариков.

## копи баллы

в средний стакан кладём около 50 г варёной бобы — примерно 50 шариков. столько же бобаллов (бб) капает за один оплаченный напиток.

+50 бб с напитка · 250 бб = бесплатный напиток (пять порций).

закуски и добавки не копятся. за подарок бобаллы не капают. списать 250 бб можно в корзине или на кассе.`,
  },
  {
